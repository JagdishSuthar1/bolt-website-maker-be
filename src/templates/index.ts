export const reactTemplate = `<boltArtifact id="project-import" title="Project Files">
...
export const nextjsTemplate = `<boltArtifact id="project-import" title="Project Files">
<boltAction type="file" filePath="package.json">{
